...
function step0() {
	...
	que.innerHTML="Do you like watching TV?";
	que_id.innerHTML=1
	audio1.play();
...
//Step1 fun
function step1(){
	que.innerHTML="How often do you watch TV?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="What kind of TV programs do you like to watch?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="What’s your favorite TV program?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Do you ever watch foreign programs or films?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Has television changed your life in any way?";
	que_id.innerHTML=6
	audio6.play();
...
function step6(){
	que.innerHTML=`<p><b>Describe an advertisement that persuaded you to buy a product.</b></p><p>You should say:</p><ul><li>What advertisement it was</li><li>Was it shown on TV, radio or newspaper</li><li>What was good about that advertisement</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>`;
	que_id.innerHTML=7
	audio8.play();
...
function step7(){
	que.innerHTML="What makes an advertisement effective?";
	que_id.innerHTML=8
	audio10.play();
...
function step8(){
	que.innerHTML="What is the purpose of advertising?";
	que_id.innerHTML=9
	audio11.play();
...
function step9(){
	que.innerHTML="How have advertisements changed since you were a child?";
	que_id.innerHTML=10
	audio12.play();
...
function step10(){
	que.innerHTML="Do you think that advertisements should be strictly regulated?";
	que_id.innerHTML=11
	audio13.play();
...
function step11(){
	que.innerHTML="How important is it for advertisers to tell the whole truth in advertisements?";
	que_id.innerHTML=12
	audio14.play();
