...
//Step1
function step0() {
	que.innerHTML="Do you miss your life at school?";
	que_id.innerHTML=1
	audio1.play();
...
//Step1 fun
function step1(){
	que.innerHTML="Who was your favorite teacher at school?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="Do you still keep in touch with your friends from school?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="Do you have a best friend?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="How often do you meet with your friends?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="What do you spend your time with them?";
	que_id.innerHTML=6
	audio6.play();
