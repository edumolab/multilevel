...
//Step1
function step0() {
	que.innerHTML="Is your hometown famous for anything?";
	que_id.innerHTML=1
	audio1.play();
...
//Step1 fun
function step1(){
	que.innerHTML="What do you like most about living in your hometown?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="Do you like your hometown?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="Would you say it's an interesting place?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="What would you say are the good points and the bad points of your hometown?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Did your friends also grow up in the same place as you?";
	que_id.innerHTML=6
	audio6.play();
