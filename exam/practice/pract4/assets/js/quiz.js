...
//Step1
function step0() {
	que.innerHTML="When do you usually get up in the morning?";
	que_id.innerHTML=1
	audio1.play();
...
//Step1 fun
function step1(){
	que.innerHTML="Do you usually have the same routine every day?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="What is your daily routine?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="Do you ever change your routine?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Is your routine the same today as it was when you were a child?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Do you have a hobby?";
	que_id.innerHTML=6
	audio6.play();
