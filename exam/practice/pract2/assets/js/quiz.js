...
//Step1
function step0() {
	que.innerHTML="Where is your hometown?";
	que_id.innerHTML=1
	audio1.play();
...
function step2(){
	que.innerHTML="Were there any changes in your hometown in recent years?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="How many people are there in your immediate family?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Who do you get on best within your family?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="What do you do together with your family?";
	que_id.innerHTML=6
	audio6.play();
