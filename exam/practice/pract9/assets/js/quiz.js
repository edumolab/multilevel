...
//Step1 fun
function step1(){
	que.innerHTML="Will you buy something because of an advertisement?";
	que_id.innerHTML=2
	audio2.play();
...
function step3(){
	que.innerHTML="What kind of movies do you like?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Do you usually watch films alone or with others?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Which actor would you like to play you in a film?";
	que_id.innerHTML=6
	audio6.play();
