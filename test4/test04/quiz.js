...
function step0() {
	...
	que.innerHTML="How often do you go to the cinema?";
	que_id.innerHTML=1
...
//Step1 fun
function step1(){
	que.innerHTML="Are cinema tickets expensive in your country?";
	que_id.innerHTML=2
	document.getElementById("result").style.display="none"
	audio2.play();
...
function step2(){
	que.innerHTML="What are the advantages of seeing a film at the cinema?";
	que_id.innerHTML=3
	document.getElementById("result").style.display="none"
	audio3.play();
...
function step3(){
	que.innerHTML="Do you still enjoy watching the movies you loved as a child?";
	que_id.innerHTML=4
	document.getElementById("result").style.display="none"
	audio4.play();
...
function step4(){
	que.innerHTML="Do you prefer going to cinema with friends or watching films at home?";
	que_id.innerHTML=5
	document.getElementById("result").style.display="none"
	audio5.play();
...
function step5(){
	que.innerHTML="What types of movies do you like?";
	que_id.innerHTML=6
	document.getElementById("result").style.display="none"
	audio6.play();
...
function step6(){
	que.innerHTML=`<p><b>Describe an unforgettable event from your childhood.</b></p><p>You should say:</p><ul><li>What is it?</li><li>when it happened</li><li>how you felt at the time</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>`;
	que_id.innerHTML=7
	audio8.play();
...
function step7(){
	que.innerHTML="Why do people often miss their childhood?";
	que_id.innerHTML=8
	audio10.play();
...
function step8(){
	que.innerHTML="Do you think kids are happier than adults?";
	que_id.innerHTML=9
	audio11.play();
...
function step9(){
	que.innerHTML="Do you think people often stay in touch with their childhood friends?";
	que_id.innerHTML=10
	audio12.play();
...
function step10(){
	que.innerHTML="Is it important to have beautiful childhood memories?";
	que_id.innerHTML=11
	audio13.play();
...
function step11(){
	que.innerHTML="What is more important for a child’s happiness, many toys or many friends?";
	que_id.innerHTML=12
	audio14.play();
